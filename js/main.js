...
if (età <= 18) {
    ...
    document.getElementById("complimenti").innerHTML = ("Complimenti! hai uno sconto riservato ai minorenni!")
}
    ...
    document.getElementById("complimenti").innerHTML = ("Complimenti! hai uno sconto riservato agli over 65 anni!")
}
